        ...
        events: {
            ...
            'change #income_expense_values': function(e) {
                ...
                if (value=="this_year"){
                    ...
                    this.onclick_act_year($target.val());
                }else if (value=="this_month"){
                    this.onclick_this_month($target.val()),
                    this.onclick_act_month($target.val()),
                    ...
                    this.onclick_act_quarter($target.val());
                }else if (value=="all"){
                    ...
                    this.onclick_act_all($target.val());
                }
...
//                $('#total_revenue_this_quarter').append('<span>' + result.opportunity_ratio_value + '</span>');
        ...
        onclick_act_quarter: function (ev) {
       var self = this;
            rpc.query({
                model: 'hr.applicant',
                method: 'act_quarter',
            ...
            .then(function (result) {
               $('#act_all_this_all').hide();
                $('#act_on_this_all').hide();
                $('#act_not_this_all').hide();
                $('#act_com_this_all').hide();
                $('#act_over_this_all').hide();
                $('#act_in_this_all').hide();
                $('#act_all_this_year').hide();
                $('#act_on_this_year').hide();
                $('#act_not_this_year').hide();
                $('#act_com_this_year').hide();
                $('#act_over_this_year').hide();
                $('#act_in_this_year').hide();
$('#act_all_this_month').hide();
                $('#act_on_this_month').hide();
                $('#act_not_this_month').hide();
                $('#act_com_this_month').hide();
                $('#act_over_this_month').hide();
                $('#act_in_this_month').hide();

               $('#act_all_this_quarter').show();
                $('#act_on_this_quarter').show();
                $('#act_not_this_quarter').show();
                $('#act_com_this_quarter').show();
                $('#act_over_this_quarter').show();
                $('#act_in_this_quarter').show();


                $('#act_all_this_quarter').empty();
                $('#act_on_this_quarter').empty();
                $('#act_not_this_quarter').empty();
                $('#act_com_this_quarter').empty();
                $('#act_over_this_quarter').empty();
                $('#act_in_this_quarter').empty();


                $('#act_all_this_quarter').append('<span>' + result.act_all + '</span>');
                $('#act_on_this_quarter').append('<span>' + result.act_on + '</span>');
                $('#act_not_this_quarter').append('<span>' + result.act_not + '</span>');
                $('#act_com_this_quarter').append('<span>' + result.act_com + '</span>');
                $('#act_over_this_quarter').append('<span>' + result.act_over + '</span>');
                $('#act_in_this_quarter').append('<span>' + result.act_in + '</span>');
//                $('#exp_rev_this_quarter').append('<span>' + self.monthly_goals[2] + '&nbsp' + result.record_rev_exp + '</span>');
//                $('#rev_this_quarter').append('<span>' + self.monthly_goals[2] + '&nbsp' + result.record_rev + '</span>');
//                $('#ratio_this_quarter').append('<span>' + result.record_ratio + '</span>');
//                $('#avg_time_this_quarter').append('<span>' + result.avg_time  + '&nbspsec' + '</span>');
       ...
       var self = this;
            ...
            .then(function (result) {
               $('#act_all_this_all').hide();
                ...
                $('#act_over_this_all').hide();
                $('#act_in_this_all').hide();
               $('#act_all_this_quarter').hide();
                $('#act_on_this_quarter').hide();
                $('#act_not_this_quarter').hide();
                $('#act_com_this_quarter').hide();
                $('#act_over_this_quarter').hide();
                $('#act_in_this_quarter').hide();
$('#act_all_this_month').hide();
                $('#act_on_this_month').hide();
                $('#act_not_this_month').hide();
                $('#act_com_this_month').hide();
                ...
                $('#act_all_this_year').show();
                $('#act_on_this_year').show();
                $('#act_not_this_year').show();
                $('#act_com_this_year').show();
                $('#act_over_this_year').show();
                $('#act_in_this_year').show();

                 $('#act_all_this_year').empty();
                $('#act_on_this_year').empty();
                $('#act_not_this_year').empty();
                $('#act_com_this_year').empty();
                $('#act_over_this_year').empty();
                $('#act_in_this_year').empty();


                $('#act_all_this_year').append('<span>' + result.act_all + '</span>');
                $('#act_on_this_year').append('<span>' + result.act_on + '</span>');
                $('#act_not_this_year').append('<span>' + result.act_not + '</span>');
                $('#act_com_this_year').append('<span>' + result.act_com + '</span>');
                $('#act_over_this_year').append('<span>' + result.act_over + '</span>');
                $('#act_in_this_year').append('<span>' + result.act_in + '</span>');
//                $('#exp_rev_this_quarter').append('<span>' + self.monthly_goals[2] + '&nbsp' + result.record_rev_exp + '</span>');
//                $('#rev_this_quarter').append('<span>' + self.monthly_goals[2] + '&nbsp' + result.record_rev + '</span>');
//                $('#ratio_this_quarter').append('<span>' + result.record_ratio + '</span>');
//                $('#avg_time_this_quarter').append('<span>' + result.avg_time  + '&nbspsec' + '</span>');
       ...
       var self = this;
            ...
            .then(function (result) {
               ...
               $('#act_all_this_quarter').hide();
                ...
                $('#act_all_this_month').show();
                $('#act_on_this_month').show();
                $('#act_not_this_month').show();
                $('#act_com_this_month').show();
                $('#act_over_this_month').show();
                $('#act_in_this_month').show();

                 $('#act_all_this_month').empty();
                $('#act_on_this_month').empty();
                $('#act_not_this_month').empty();
                $('#act_com_this_month').empty();
                $('#act_over_this_month').empty();
                $('#act_in_this_month').empty();


                $('#act_all_this_month').append('<span>' + result.act_all + '</span>');
                $('#act_on_this_month').append('<span>' + result.act_on + '</span>');
                $('#act_not_this_month').append('<span>' + result.act_not + '</span>');
                $('#act_com_this_month').append('<span>' + result.act_com + '</span>');
                $('#act_over_this_month').append('<span>' + result.act_over + '</span>');
                $('#act_in_this_month').append('<span>' + result.act_in + '</span>');
//                $('#exp_rev_this_quarter').append('<span>' + self.monthly_goals[2] + '&nbsp' + result.record_rev_exp + '</span>');
//                $('#rev_this_quarter').append('<span>' + self.monthly_goals[2] + '&nbsp' + result.record_rev + '</span>');
//                $('#ratio_this_quarter').append('<span>' + result.record_ratio + '</span>');
//                $('#avg_time_this_quarter').append('<span>' + result.avg_time  + '&nbspsec' + '</span>');
...
$('#act_all_this_month').hide();
               ...
               $('#act_all_this_all').show();
                $('#act_on_this_all').show();
                $('#act_not_this_all').show();
                $('#act_com_this_all').show();
                $('#act_over_this_all').show();
                $('#act_in_this_all').show();


                $('#act_all_this_all').empty();
                $('#act_on_this_all').empty();
                $('#act_not_this_all').empty();
                $('#act_com_this_all').empty();
                $('#act_over_this_all').empty();
                $('#act_in_this_all').empty();


                $('#act_all_this_all').append('<span>' + result.act_all + '</span>');
                $('#act_on_this_all').append('<span>' + result.act_on + '</span>');
                $('#act_not_this_all').append('<span>' + result.act_not + '</span>');
                $('#act_com_this_all').append('<span>' + result.act_com + '</span>');
                $('#act_over_this_all').append('<span>' + result.act_over + '</span>');
                $('#act_in_this_all').append('<span>' + result.act_in + '</span>');
//                $('#exp_rev_this_quarter').append('<span>' + self.monthly_goals[2] + '&nbsp' + result.record_rev_exp + '</span>');
//                $('#rev_this_quarter').append('<span>' + self.monthly_goals[2] + '&nbsp' + result.record_rev + '</span>');
//                $('#ratio_this_quarter').append('<span>' + result.record_ratio + '</span>');
//                $('#avg_time_this_quarter').append('<span>' + result.avg_time  + '&nbspsec' + '</span>');
